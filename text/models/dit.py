...
class DDiTBlock(nn.Module):
  ...
  def forward(self, x, rotary_cos_sin, c=None, seqlens=None, exclude_last_token=False):
    ...
    if exclude_last_token:
      q, k, v = split_and_apply_rotary_pos_emb(qkv[:, :-1], rotary_cos_sin) # exclude_last_token
      ...
      q, k, v = split_and_apply_rotary_pos_emb(qkv, rotary_cos_sin) # exclude_last_token
